...
func main() {
	url := "http://localhost:8999/tech-sdkwrapper/timevale/sign/userFileSign"
	...
	fileParam := make(map[string]string)
	fileParam["srcPdfFile"] = "/Users/pathbox/edst_file/0001_done.pdf"
	fileParam["dstPdfFile"] = "/Users/pathbox/edst_file/0001_ok_done.pdf"
	fileParam["fileName"] = "测试合同"
	signPos := make(map[string]interface{})
	signPos["posType"] = 0
	signPos["posPage"] = "1"
	signPos["posX"] = 500
	signPos["posY"] = 100
	params["file"] = fileParam
	params["signPos"] = signPos
