...
func printf(format string, a ...interface{}) (n int, err error) {
	return fmt.Fprint(color.Output, format, a...)
}
...
func parseURL(uri string) *url.URL {
	if !strings.Contain(uri, "://") && !strings.HasPrefix(uri, "//") {
		uri = "//" + uri
	}
...
func dialContext(network string) func(ctx context.Context,network, addr string) {
